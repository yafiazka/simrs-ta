...
class PenyakitSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $commonDiseases = [
            ...
            'A57' => ['nm' => 'Infeksi Kanker Kelamin / Chlamydia', 'en' => 'Other venereal diseases', 'ciri' => 'Nyeri kemerahan area genital, cairan sekret abnormal.', 'ket' => 'Penyakit Menular Seksual', 'status' => 'Menular', 'ktg' => 'K01'],
            'B17' => ['nm' => 'Hepatitis Virus Akut Lainnya', 'en' => 'Other acute viral hepatitis', 'ciri' => 'Demam, lemas, kulit/mata kuning.', 'ket' => 'Penyakit Infeksi Hati', 'status' => 'Menular', 'ktg' => 'K01'],
            'B87' => ['nm' => 'Miasis (Infeksi Belatung)', 'en' => 'Myiasis', 'ciri' => 'Luka terbuka terinfeksi larva serangga.', 'ket' => 'Infeksi Parasit', 'status' => 'Menular', 'ktg' => 'K01'],
            'B97' => ['nm' => 'Agen Virus Penyebab Penyakit', 'en' => 'Viral agents as the cause of diseases', 'ciri' => 'Infeksi sekunder agen viral.', 'ket' => 'Infeksi Virus', 'status' => 'Menular', 'ktg' => 'K01'],
            'C29' => ['nm' => 'Neoplasma Ganas Saluran Empedu', 'en' => 'Malignant neoplasm of gallbladder', 'ciri' => 'Nyeri perut kanan atas, ikterus, berat badan turun.', 'ket' => 'Onkologi / Kanker', 'status' => 'Tidak Menular', 'ktg' => 'K03'],
            'D06' => ['nm' => 'Karsinoma in situ Serviks Uteri', 'en' => 'Carcinoma in situ of cervix uteri', 'ciri' => 'Perdarahan abnormal pasca sanggama.', 'ket' => 'Onkologi Ginekologi', 'status' => 'Tidak Menular', 'ktg' => 'K03'],
            'D71' => ['nm' => 'Gangguan Fungsi Neutrofil PMN', 'en' => 'PMN neutrophil dysfunction', 'ciri' => 'Rentan infeksi bakteri berulang.', 'ket' => 'Gangguan Imunologi', 'status' => 'Tidak Menular', 'ktg' => 'K04'],
            'H63' => ['nm' => 'Gangguan Telinga Pada Penyakit Lain', 'en' => 'Disorders of ear in diseases classified elsewhere', 'ciri' => 'Nyeri dan dengung telinga.', 'ket' => 'Gangguan THT', 'status' => 'Tidak Menular', 'ktg' => 'K02'],
            'I05' => ['nm' => 'Penyakit Katup Mitral Reumatik', 'en' => 'Rheumatic mitral valve diseases', 'ciri' => 'Sesak napas, bengkak kaki, riwayat demam reumatik.', 'ket' => 'Penyakit Jantung Reumatik', 'status' => 'Tidak Menular', 'ktg' => 'K05'],
            'J31' => ['nm' => 'Rinitis dan Nasofaringitis Kronis', 'en' => 'Chronic rhinitis, nasopharyngitis and pharyngitis', 'ciri' => 'Hidung tersumbat kronis, batuk dahak tenggorokan.', 'ket' => 'Infeksi Pernapasan Kronis', 'status' => 'Tidak Menular', 'ktg' => 'K02'],
            'J50' => ['nm' => 'Penyakit Pernapasan Kronis Lainnya', 'en' => 'Other chronic respiratory diseases', 'ciri' => 'Batuk berdahak kronis, sesak napas saat aktivitas.', 'ket' => 'Penyakit Paru Kronis', 'status' => 'Tidak Menular', 'ktg' => 'K02'],
            'J63' => ['nm' => 'Pneumokoniosis Akibat Debu Organik', 'en' => 'Pneumoconiosis due to other inorganic dusts', 'ciri' => 'Sesak napas berat, batuk debu industri.', 'ket' => 'Penyakit Paru Kerja', 'status' => 'Tidak Menular', 'ktg' => 'K02'],
            'L82' => ['nm' => 'Keratosis Seboroik', 'en' => 'Seborrheic keratosis', 'ciri' => 'Bercak kecokelatan timbul seperti kutil licin pada kulit.', 'ket' => 'Gangguan Kulit Benigna', 'status' => 'Tidak Menular', 'ktg' => 'K06'],
            'Q34' => ['nm' => 'Kelainan Kongenital Pernapasan Lainnya', 'en' => 'Other congenital malformations of respiratory system', 'ciri' => 'Sesak napas pada bayi sejak lahir.', 'ket' => 'Kelainan Bawaan Organ', 'status' => 'Tidak Menular', 'ktg' => 'K09'],
            'R56' => ['nm' => 'Kejang Demam (Kejang Step)', 'en' => 'Convulsions, not elsewhere classified', 'ciri' => 'Kejang kaku/kelonjotan saat demam tinggi pada anak.', 'ket' => 'Gejala Saraf Anak', 'status' => 'Tidak Menular', 'ktg' => 'K10'],
            'S76' => ['nm' => 'Cedera Otot dan Tendon Paha', 'en' => 'Injury of muscle and tendon at thigh level', 'ciri' => 'Nyeri hebat, bengkak, memar area paha pasca trauma.', 'ket' => 'Trauma Muskuloskeletal', 'status' => 'Tidak Menular', 'ktg' => 'K10'],
            'T02' => ['nm' => 'Fraktur Fraktur Beragam Regio Tubuh', 'en' => 'Fractures involving multiple body regions', 'ciri' => 'Patah tulang di beberapa lokasi tubuh akibat kecelakaan.', 'ket' => 'Trauma Gawat Darurat', 'status' => 'Tidak Menular', 'ktg' => 'K10'],
