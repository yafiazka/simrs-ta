...
use App\Filament\Resources\PoliMtbsResource\Pages;
...
class PoliMtbsResource extends Resource
{
    protected static ?string $model = RegPeriksa::class;

    protected static ?string $navigationIcon = 'heroicon-o-face-smile';
    protected static ?string $navigationGroup = 'Pelayanan Klinis';
    protected static ?string $pluralLabel = 'Poli MTBS';
    protected static ?string $navigationLabel = 'Poli MTBS';
    ...
    {
        return [
            'index' => Pages\ListPoliMtbs::route('/'),
        ];
    }
}
